...
export default function Home() {
  return (
      ...
      <div className="w-full">
        <div className="firstSection pt-[130px] 1md:overflow-x-auto overflow-x-hidden px-4">
          <motion.div
            ...
            viewport={{ once: true }}
            className="sm:max-w-[500px] max-w-[680px] break-words  px-4 block mx-auto w-full  font-medium leading-snug sm:text-[60px] 1sm:text-[50px] text-[45px]  tracking-[-2px] bg-clip-text bg-gradient-to-r text-transparent from-white/100 to-white/5   text-center"
          >
   ...
   className="max-w-fit px-4 mx-auto relative top-[-8px] leading-snug w-full font-medium sm:text-[60px] 1sm:text-[50px] text-[45px] tracking-[-2px] bg-clip-text bg-gradient-to-r text-transparent from-white/100 to-white/5  text-center">Entire Portfolio</motion.div> */}
          ...
          >
            Empowering property managers, landlords, and tenants — supercharging
            the speed of daily operations and unlocking insights to boost
            revenue. It&apos;s the future of property management.
          </motion.div>
