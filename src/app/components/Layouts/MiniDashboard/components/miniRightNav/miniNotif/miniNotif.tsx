...
export default function MiniNotif() {
  return (
    <div className="w-[100%]">
      ...
      <div
        className={`flex flex-col mt-3 h-[180px] overflow-hidden text-white/85`}
      >
        <div className="p-2 flex gap-x-2">
          <PiBugBeetle className="text-xl text-[#1C1C1C] bg-[#E3F5FF] rounded-full p-1" />

          <div className="flex-1">
            <h1 className="text-white/85 font-[400] text-[11px]">
              Bin collection due
            </h1>
        ...
        <div className="p-2 flex gap-x-2">
          ...
          <div className="flex-1">
            ...
            <p className="text-white/30 text-[9px] font-[400]">
              59 minutes ago
            </p>
          </div>
        </div>
