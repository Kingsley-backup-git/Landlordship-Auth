...
<div  className={`flex gap-x-2 p-2 hover:bg-[#1C1C1C0D]  rounded-xl items-center `}>
...
<div className='w-full py-1'>
   ...
   <h1 className='flex-1 text-white/85 text-[10px] font-[400]'>Properties</h1> 

   
    </div>
  <div className='flex flex-col gap-y-1'>
<div   className={`text-white/85  rounded-xl  text-[10px] font-[400] py-2 px-6  `}>Units</div>
<div   className={`text-white/85 rounded-xl text-[10px] font-[400] py-2 px-6 `}>Buildings</div>
...
<h1 className='text-white/85 text-[10px] font-[400] flex-1'>Maintenance</h1> 
</div>
