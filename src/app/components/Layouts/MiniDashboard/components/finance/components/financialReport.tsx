...
<div className='font-semibold text-white/90 text-sm flex-1'>Financial report</div>


<div className='flex items-center gap-x-3'>
    <li className='font-[400] text-sm list-none text-white/50 cursor-pointer'>This Year</li>
    <li className='text-white/20 list-none font-[400] text-sm cursor-pointer'>2023</li>
    <li className='font-[400] text-sm list-none text-white/20 cursor-pointer'>2022</li>
</div>
</div>
