...
{maintenance.img.length > 2 && <div className='w-[18px] h-[18px] rounded-full bg-white items-center p-1 relative left-[-8px] flex justify-center text-black font-[400] text-[9px]'>+{maintenance.img.length - 2 }</div> }
    </div>
