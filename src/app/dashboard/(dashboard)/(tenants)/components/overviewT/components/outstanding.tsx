...
export default function Outstanding() {
  ...
  return (
    <div className="sm:bg-[#F9F9FA] bg-white rounded-2xl lg:order-3 sm:order-4 order-last py-6 sm:px-6 p-3 flex flex-col  max-h-[350px]  col-span-12 lg:col-span-8">
            ...
            <div key={index} className="grid grid-cols-12 gap-x-2 items-center">
              ...
              <div className="col-span-2 sm:col-span-2 sm:flex hidden items-center">
                ...
                {maintenance.img.length > 2 && (
                  <div className="w-[18px] h-[18px] rounded-full bg-white items-center p-1 relative left-[-8px] flex justify-center text-black font-[400] text-xs">
                    +{maintenance.img.length - 2}
                  </div>
                )}
              </div>
