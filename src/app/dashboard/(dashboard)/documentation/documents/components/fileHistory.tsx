          ...
          <div className="flex items-center w-[100%] py-3 border-b-[1px] border-[#0000000A]">
            <div className="flex-[5%] ps-1">
              <Checkbox
                clicked={() => toggleAll()}
                checked={allChecked}
                classname={`w-[14px] cursor-pointer h-[14px] border-[#00000033] flex justify-center items-center  border-[1px] ${allChecked ? "bg-black" : ""}`}
                value={""}
              />
            </div>
            ...
            {fileHistory.map((history, index) => {
              return (
                <div
                  key={index}
                  onClick={() => null}
                  className={`flex z-[-1px]  gap-x-5 items-center cursor-pointer py-3 w-full  hover:rounded-xl border-b-[1px] border-[#0000000A] hover:bg-[#0000000A]`}
