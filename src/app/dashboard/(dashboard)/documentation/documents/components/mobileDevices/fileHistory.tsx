        ...
        return (
          <div className="bg-white rounded-2xl p-4" key={index}>
            <div className="flex items-center gap-x-2">
              {file.type === "pdf" ? (
                <PiFilePdf className="text-black text-3xl bg-[#0000000A] rounded-lg p-1" />
              ) : file.type === "file" ? (
                <VscFolder className="text-black text-3xl bg-[#0000000A] rounded-lg p-1" />
              ) : file.type === "jpeg" ? (
                <PiFileJpg className="text-black text-3xl bg-[#0000000A] rounded-lg p-1" />
              ) : null}{" "}
              <h1 className="font-semibold text-black text-sm">{file.file}</h1>
            </div>

            <div className="flex flex-col divide-y-[1px] mt-1">
              <div className="flex items-center justify-between py-2">
                <h1 className="font-[400px] text-[#00000066] flex-1 xs:text-sm text-xs">
                  Uploader
                </h1>
