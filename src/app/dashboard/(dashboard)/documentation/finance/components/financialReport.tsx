      ...
      <div className="bg-[#F9F9FA] rounded-2xl p-6 mt-6 sm:flex hidden flex-col h-[312px]  w-[100%]">
        <div className="flex items-center gap-x-2">
          ...
          <div className="flex items-center gap-x-3">
            <li className="font-[400] text-sm list-none text-black cursor-pointer">
              This Year
            </li>
            <li className="text-[#00000066] list-none font-[400] text-sm cursor-pointer">
              2023
            </li>
            <li className="font-[400] text-sm list-none text-[#00000066] cursor-pointer">
              2022
            </li>
          </div>
        </div>
