...
{expenses.map((expense, index)=> {
  return <div key={index} className= {`${index % 2 === 0 ? "bg-[#00000008]" : "bg-[#00000003]"} flex items-center px-3 py-2 gap-x-4 rounded-2xl`}>
<div className='flex-1 text-black font-[400] text-sm'>{expense.name}</div>
<div className=' text-black font-[400] text-sm'>{expense.amount}</div>
  </div>
})}
 </div>
    </div>
