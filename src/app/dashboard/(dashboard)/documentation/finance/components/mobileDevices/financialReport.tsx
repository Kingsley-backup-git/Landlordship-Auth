    ...
    <>
      <div className="bg-white rounded-2xl p-4 mt-6 sm:hidden flex flex-col h-[312px]  w-[100%]">
        <div className="flex items-center gap-x-2">
          <div className="font-semibold text-black text-sm flex-1">
            Financial report
          </div>

          <div className="flex items-center gap-x-4">
            <li className="font-[400] xs:text-sm text-xs list-none text-black cursor-pointer">
              This Year
            </li>
            <li className="text-[#00000066] list-none font-[400] xs:text-sm text-xs cursor-pointer">
              2023
            </li>
            <li className="font-[400] xs:text-sm text-xs list-none text-[#00000066] cursor-pointer">
              2022
            </li>
          </div>
        </div>
        ...
        >
          {reports.map((report, index) => {
            return (
              <div
                key={index}
                className={`${index % 2 === 0 ? "bg-[#00000008]" : "bg-[#00000003]"} flex items-center px-3 py-2 gap-x-2 rounded-2xl`}
              >
