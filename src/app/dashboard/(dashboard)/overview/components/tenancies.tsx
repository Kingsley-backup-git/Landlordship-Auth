...
export default function Tenancies() {
  return (
   <div className='bg-[#E6F1FD] rounded-2xl sm:p-6 p-4 sm:col-span-1 col-span-4 1sm:col-span-2'>
 ...
 <h1 className='sm:text-xl text-base font-semibold text-black'>31</h1>
