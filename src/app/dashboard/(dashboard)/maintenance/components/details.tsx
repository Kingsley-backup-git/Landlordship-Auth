...
<div className='flex items-center gap-x-4'>
    <li className='list-none'><span className='text-[#00000066] font-[400] text-sm'>Change Status</span> <GrFormDown className='inline-block align-middle text-lg text-[#00000066]'/></li>

    <li className='text-[#00000066] list-none text-sm font-[400]'>Send message</li>
