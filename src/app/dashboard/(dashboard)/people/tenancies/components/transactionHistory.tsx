...
return <div key = {index}  className='flex gap-x-4 items-center cursor-pointer hover:bg-[#0000000A]  py-3 border-b-[1px] border-[#0000000A]' onMouseLeave={()=>  setShow(null)} onMouseEnter={()=> setShow(index)}>
    <div className='flex-[3%] ps-1'>
