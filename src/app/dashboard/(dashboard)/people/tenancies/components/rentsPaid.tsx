  ...
  return (
    <div className="bg-[#EDEEFC] rounded-2xl sm:p-6 p-4 ">
      <div className="flex items-center">
        ...
        <PiMoneyDuotone className="text-[#1C1C1C] sm:min-w-[20px] sm:min-h-[20px] sm:max-w-[20px] max-w-[19px] min-w-[19px] min-h-[19px] w-[100%] h-[100%]" />
      </div>

      <div className="mt-4 flex  gap-x-2 items-center">
        <h1 className="xs:text-xl flex-1 text-base font-semibold text-black text-break">
          £3,290
        </h1>
