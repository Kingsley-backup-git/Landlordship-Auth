...
export default function StepOne({header, stepHandler}:{header:string, stepHandler : (num:number)=> void;}) {
  return (
...
<Dropdown text="Property" className="py-4 px-5 mt-5 rounded-2xl mx-auto block w-full max-w-[400px] bg-[#FFFFFFCC] border-[.5px] border-[#0000001A]"/>
...
<Button onClick={()=> stepHandler(2)} classname='bg-[#1D3639] flex items-center gap-x-2 justify-center max-w-[170px] w-full rounded-xl py-2 px-4'>
