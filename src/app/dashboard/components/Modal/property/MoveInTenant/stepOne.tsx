        ...
        <div className="sm:p-6 py-2 px-4  sm:max-w-[960px] mx-auto w-[100%]">
          ...
          <div className="mt-16 justify-center max-w-[600px] mx-auto w-full">
            ...
            <p className="text-sm text-center mt-2 font-[400] text-[#00000066]">
              Select the property and unit below.
            </p>
            ...
            <Dropdown
              ...
              text="Property"
              className="py-4 px-5 mt-5 rounded-2xl mx-auto block w-full max-w-[400px] bg-[#FFFFFFCC] border-[.5px] border-[#0000001A]"
            />
            ...
            <div className="flex items-center gap-x-4 mt-6 justify-center">
              ...
              <Button
                ...
                classname={`${propertyId === "" ? "bg-gray-300 cursor-not-allowed pointer-events-none" : "bg-[#1D3639] cursor-pointer"} flex items-center gap-x-2 justify-center max-w-[170px] w-full rounded-xl py-2 px-4`}
              >
