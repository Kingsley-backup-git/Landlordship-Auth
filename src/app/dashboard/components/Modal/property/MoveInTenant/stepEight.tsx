...
export default function StepEight({header, stepHandler}:{header:string, stepHandler : (num:number)=> void;}) {
...
<h1 className='font-semibold text-xl text-black text-center'>Add automatic recurring rent</h1>
<p className="mt-1 text-sm font-[400] text-center text-[#00000066]">Enable the automatic lease rent invoicing.</p>

<div className="max-w-[400px] mt-6 w-full mx-auto">
<TextField className='w-full  bg-[#FFFFFFCC] border-[0.5px] border-[#0000001A] py-4 px-5 rounded-2xl' 
type='number' 
text='Amount'
...
<Button onClick={()=> stepHandler(7)} classname='bg-[#0000000A] flex flex-1 items-center justify-center gap-x-2 rounded-xl py-2 px-4'>
