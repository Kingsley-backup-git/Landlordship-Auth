...
<Button onClick={()=> stepHandler(6)} classname='bg-[#0000000A] flex flex-1 items-center justify-center gap-x-2 rounded-xl py-2 px-4'>
<FaAngleLeft className='text-[#00000066] text-base'/>
  <h1 className="text-sm font-[400] text-black">Previous</h1>
</Button>

<Button onClick={()=> stepHandler(8)} classname='bg-[#1D3639] flex flex-1 items-center gap-x-2 justify-center rounded-xl py-2 px-4'>
