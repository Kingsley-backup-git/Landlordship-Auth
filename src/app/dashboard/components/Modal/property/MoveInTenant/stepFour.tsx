...
<TextField onChange = {(e)=> setTenant({...tenant, lastname:e.target.value})} className="border-[.5px] border-[#0000001A] py-3 px-4 rounded-2xl bg-[#FFFFFFCC]" text="" type="text" placeholder = "Last Name"/> */}
          ...
          <TextField
            ...
            className="border-[.5px] col-span-2 border-[#0000001A] py-3 px-4 rounded-2xl bg-[#FFFFFFCC]"
            text="Email"
            type="email"
...
<PhoneInput className="border-[.5px] col-span-2 border-[#0000001A] py-3 px-4 rounded-2xl bg-[#FFFFFFCC]" text="Phone" type="tel" placeholder = ""/> */}
        ...
        <div className="flex items-center gap-x-4 mt-6 w-full">
          <Button
            text="Cancel"
            type="button"
            classname="bg-[#0000000A] text-sm font-[400] text-black flex-1 items-center  w-full rounded-xl py-2 px-4"
          ...
          <Button
            ...
            type="submit"
            disabled={disabled}
            classname={`${disabled || !!formik.errors.email ? "bg-gray-300 cursor-not-allowed" : "bg-[#1D3639] cursor-pointer"} text-sm font-[400] text-white  items-center flex-1 w-full rounded-xl py-2 px-4`}
