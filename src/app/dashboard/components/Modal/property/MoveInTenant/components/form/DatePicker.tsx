...
export default function DatePickerInput({className, text, startDate, startDateHandler} : TextField) {
  return (
    <div className={className}>
<label className='text-[#00000066] block text-xs font-normal'>{text}</label>
