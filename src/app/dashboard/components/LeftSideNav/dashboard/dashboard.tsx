...
<div className='w-full py-1'>
    <Link href = "/dashboard/properties" className={`flex gap-x-2 rounded-xl hover:bg-[#1C1C1C0D]  items-center ${leftNav ? "" : "justify-center"} p-2 cursor-pointer ${pathname.includes("/properties") ? "bg-[#1C1C1C0D]": null}`}>
...
{leftNav  ? <h1 className='text-[#1C1C1C] text-xs font-[400]'>Files</h1> : null }
</Link> */}
