...
export default function PeopleList({leftNav} : {leftNav:boolean}) {
  const pathname = usePathname()
  return (
    <div className='mt-1 pt-1 pb-2'>
       {leftNav ? <h1 className='ps-3 text-[#1C1C1C66] text-sm front-[400]'>People</h1> : null}
...
{leftNav ? <h1 className='text-[#1C1C1C] text-xs font-[400]'>Tenants</h1> : null}
</Link>
...
{leftNav ? <h1 className='text-[#1C1C1C] text-xs font-[400]'>Tenancies</h1> : null}
</Link>
...
{leftNav ? <h1 className='text-[#1C1C1C] text-xs font-[400]'>Applications</h1> : null} 
</Link>
...
{leftNav ? <h1 className='text-[#1C1C1C] text-xs font-[400]'>Agents</h1> : null }
</Link>
