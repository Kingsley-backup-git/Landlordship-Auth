...
<h1 className='text-[#1C1C1C] font-[400] text-sm'>Maintenance Requests</h1>

<div className={`flex flex-col mt-4 h-[278px] overflow-auto ${styles.overflow}`}>
...
<div className={`w-[1px] h-[20px] ${(requests.length - 1 === index) && "hidden"} border-[1px] border-[#1C1C1C1A]`}></div>
</div>
<div className='flex-1'>
    <h1 className='text-[#1C1C1C] font-[400] text-sm'>{request.req}</h1>
    <p className='text-[#1C1C1C66] text-xs font-[400]'>{request.time}</p>
</div>
</div>
})}
