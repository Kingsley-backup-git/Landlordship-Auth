...
<Button classname='bg-[#0000000A] py-1 px-2 font-[400] text-sm rounded-lg text-black' text='Send late'/>

<Button classname='bg-[#E3572B] py-1 px-2 font-[400] text-sm rounded-lg text-white' text='Send'/>
    </div>
  )
}
