...
<Options />
  ...
  <div className="flex-1"></div>
         <div className="flex-1">  <h1 className = "text-black text-center  font-semibold sm:hidden block  sm:tracking-normal tracking-[-0.43px] text-sm 2sm:text-lg ">Message</h1></div>
             <div className="flex-1 flex justify-end"><BsThreeDots className='text-[#007AFF]  2sm:text-2xl text-xl sm:hidden flex'/></div> 
             </div>
...
<PiFunnelSimple className="text-lg text-black"/>
                ...
                <div className={`sm:overflow-y-auto mt-[95px] sm:mt-1 py-1 divide-y-[1px] divide-[#0000000A] ${styles.overflow} flex-1 sm:h-[160%] flex flex-col`}>
                    <Chats />
                  :
                    </div>
