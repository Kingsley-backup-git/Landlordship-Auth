  ...
  return (
    <div className="max-w-[404px] w-[100%] mt-6">
      ...
      <Button
        ...
        type="button"
        disabled={disabled}
        classname={`  ${Object.keys(loginFormik.errors).length > 0 || disabled ? "bg-gray-400 cursor-not-allowed" : "bg-[#1D3639] cursor-pointer"} mt-6 p-2 w-[100%] text-white font-[400] text-base rounded-2xl`}
        text="Sign In"
      />
      <p className="text-[#00000066] mt-4 text-center text-sm font-[400]">
        Not a Member yet?{" "}
        <Link href="/auth/signup" className="text-[#E3572B]">
          Sign Up
        </Link>
      </p>
    </div>
