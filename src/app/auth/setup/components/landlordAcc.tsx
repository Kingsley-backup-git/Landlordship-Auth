...
export default function LandlordAcc({
  accountType,
  AccountTypeHandler,
}: {
  accountType: string;
  ...
  return (
    <div
      className={`${accountType === "landlord" ? "border-[2px]" : ""} cursor-pointer relative border-[#1D3639] rounded-2xl p-6 bg-[#F9F9FA] flex gap-x-2`}
      onClick={() => AccountTypeHandler("landlord")}
    >
